	...
	<div class="popup-wrap">
		<div class="popup-content">
			...
			<div class="popup-content-text">
				...
				<p>Other than the content you own, under these Terms, SparkInvest and/or its licensors own all the intellectual property rights and materials contained in this Website.</p>
				...
				<p>Certain areas of this Website are restricted from being access by you and SparkInvest may further restrict access by you to any areas of this Website, at any time, in absolute discretion. Any user ID and password you may have for this Website are confidential and you must maintain confidentiality as well.</p>
				<h6>Your Content</h6>
				<p>In these Website Standard Terms and Conditions, “Your Content” shall mean any audio, video text, images or other material you choose to display on this Website. By displaying Your Content, you grant SparkInvest a non-exclusive, worldwide irrevocable, sub licensable license to use, reproduce, adapt, publish, translate and distribute it in any and all media.</p>
				<p>Your Content must be your own and must not be invading any third-party’s rights. SparkInvest reserves the right to remove any of Your Content from this Website at any time without notice.</p>
				<h6>No warranties</h6>
				...
				<p>SparkInvest is permitted to revise these Terms at any time as it sees fit, and by using this Website you are expected to review these Terms on a regular basis.</p>
				<h6>Assignment</h6>
		...
		<section id="" class="sec-pad null-bot null-top">
			<div class="preview-form">
				...
				<div class="pf-item2" style="display:none;">
					<div class="container">
						<div class="sec-header animated hiding" data-animation="fadeInUp">
							<h2>Awesome <br>Your Investment Plan Is Ready.</h2>
						</div>
